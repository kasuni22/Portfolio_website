  ...
  return (
    <div className="flex justify-center w-full fixed z-50 mt-4">
      <motion.nav
        ...
        className={`flex items-center justify-between ${colors.navBg} backdrop-blur-lg rounded-2xl px-4 lg:px-8 py-2 shadow-lg`}>
        <div className="flex items-center justify-between w-full space-x-6 lg:space-x-8">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            {navItems.map((item) => (
              ...
              >
                <motion.span
                  className={`text-medium transition-colors duration-300 ${activeSection === item.name.toLowerCase()
                      ? colors.textActive
